                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:280px">
                   ...
                   <tr>
                     ...
                     <tr>
                      <td align="right" style="padding:0;Margin:0">
                      <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Total&nbsp;<strong>$${order.giftCard?.discount ? Number(order.orderDetail.price) - Number(order.giftCard?.discount) : order.orderDetail.price}</strong></td>
                     </tr>
                   </table></td>
                 </tr>
                  ...
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      ...
                      <tr>
                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;padding-top:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                      Aca puedes ver tu factura &nbsp;<a target="_blank" href=${invoice} style="mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">Factura</a></p></td>
                      <tr>
                      <td>
